...
sudo apt install php8.2 php8.2-cli php8.2-common php8.2-mbstring php8.2-xml php8.2-mysql php8.2-curl php8.2-gd

sudo ln -s /etc/nginx/sites-available/innter_nat_admin /etc/nginx/sites-enabled/
sudo chown -R www-data.www-data /var/www/html/innter_nat_admin/bootstrap/cache

sudo ln -s /etc/nginx/sites-available/admin_internat.com.conf /etc/nginx/sites-enabled/
rm /etc/nginx/sites-enabled/admin_internat.com.conf
nano /etc/nginx/sites-available/admin_internat.com.conf

sudo ln -s /etc/nginx/sites-available/default /etc/nginx/sites-enabled/


be658ab4-0c45-4a2c-8171-e95513438504
