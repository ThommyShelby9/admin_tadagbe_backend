...
?>
        ...
        <div class="c-sidebar-brand ">
            <img class="c-sidebar-brand-full pull-left " src="{{ url('/assets/brand/logo_dark_lg.png') }}" width="50" height="50" alt="Logo">
            <img class="c-sidebar-brand-minimized pull-left " src="{{ url('assets/brand/logo_dark_lg.png') }}" width="50" height="50" alt="Logo">
            <span class="badge badge-light h2">Administration des Ecoles</span>
        </div>
