    ...
    <div class="c-wrapper">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        {{$user->name?? ""}}
          ...
          <div class="c-avatar">
              <img class="c-avatar-img" src="{{ url('/assets/img/avatars/avatar.png') }}" alt="Utilisateur"> 
              
            </div>
            </a>
            <div class="dropdown-menu dropdown-menu-right pt-0">
              <div class="dropdown-header bg-light py-2"><strong> {{$user->name?? ""}}</strong><br>{{$user->email?? ""}}</div><a class="dropdown-item" href="#">
                <svg class="c-icon mr-2">
                  <use xlink:href="{{ url('/icons/sprites/free.svg#cil-bell') }}"></use>
                </svg> Admissions<span class="badge badge-info ml-auto">0</span></a><a class="dropdown-item" href="#">
                <svg class="c-icon mr-2">
              ...
              <a class="dropdown-item" href="#">
                ...
                </svg> Bloquer le compte 
              </a>
                <a class="dropdown-item" href="#">
                
                <form action="{{ url('/logout') }}" method="POST">
                   @csrf <button type="submit" 
                class="btn btn-ghost-dark btn-block"><svg class="c-icon mr-2">
