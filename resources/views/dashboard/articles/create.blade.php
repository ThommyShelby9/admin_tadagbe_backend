        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('articles.store') }}" enctype='multipart/form-data' id="article_form">
                            @csrf
                            @include('dashboard.articles.form_content')
                            <button class="btn btn-success" id="submit" type="submit">Sauvegarder</button>
